...
use programs_to_debug_thread_local::is_debug_progam;
...
impl Executor for BpfExecutor {
    fn execute(
        ...
        let execution_result = {
            ...
            // ----------------- DEBUGGER --------------------
    	    let use_debug = is_debug_progam(program_id);
            let result = if use_jit {
                vm.execute_program_jit(&mut instruction_meter)
            } else {
                vm.execute_program_interpreted(&mut instruction_meter, use_debug)
            };
            // -----------------------------------------------
